...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#011230] text-[#d8e2ff] p-6 font-['Inter'] selection:bg-[#e9c349]/30">
      ...
      <div className="max-w-md w-full space-y-10 bg-[#0e1f3d]/40 backdrop-blur-2xl p-10 md:p-14 rounded-[2rem] border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
        <div className="text-center space-y-3 font-['Montserrat']">
          ...
          <p className="text-[#c5c6cd] text-lg font-light">Sign in to your luxury account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="space-y-6">
            ...
            <div className="space-y-2 group">
              <div className="flex justify-between items-center px-1">
                <label htmlFor="password" className="text-sm font-medium text-[#8f9097] transition-colors group-focus-within:text-[#e9c349]">
                  Password
                </label>
                <a href="#" className="text-xs text-[#8f9097] hover:text-[#e9c349] transition-colors">
                  Forgot Password?
                </a>
              </div>
              <input
          ...
          <p className="text-center text-[#8f9097] font-light">
            New to Shopverse?{' '}
            <a href="/register" className="text-[#e9c349] hover:text-[#d4af37] font-semibold transition-colors underline-offset-8 hover:underline">
              Create Account
            </a>
          </p>
        </form>
